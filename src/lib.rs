...
pub use local_opt::{
    effective_algorithm, minimize_local, minimize_local_with_constraints, CmaesOptions,
    ConstraintHandling, LinearConstraint, LocalOptResult, LocalOptimizer, LocalOptimizerOptions,
};
